<?php $__env->startSection('page-title', 'Add Ward'); ?>
  ...
  <div class="modal">
    ...
    <form method="POST" action="<?php echo e(route('wards.store')); ?>">
      ...
      <div class="field">
        ...
        <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. Ward 6" required>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="field-row">
        <div class="field">
          ...
          <input type="number" name="total_beds" value="<?php echo e(old('total_beds')); ?>" placeholder="e.g. 24" min="1" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\crest\wellmeadows-billing\resources\views/wards/create.blade.php ENDPATH**/ ?>