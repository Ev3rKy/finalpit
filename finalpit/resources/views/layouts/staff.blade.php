...
<head>
    ...
    <title>@yield('title', 'Wellmeadows')</title>
...
<div class="sb">
    ...
    <div class="sb-nav">
        ...
        <a href="{{ route('staff.index') }}" class="ni {{ request()->routeIs('staff.index', 'staff.show', 'staff.edit') ? 'on' : '' }}">👥 Staff Directory</a>
        <a href="{{ route('staff.create') }}" class="ni {{ request()->routeIs('staff.create') ? 'on' : '' }}">＋ Add Staff</a>
        <a href="{{ route('ward-allocation.index') }}" class="ni {{ request()->routeIs('ward-allocation.*') ? 'on' : '' }}">📅 Ward Allocation</a>
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="tb-ward">@yield('top_title', 'Staff & Department Management')</div>
        </div>
        <div class="tb-r">
