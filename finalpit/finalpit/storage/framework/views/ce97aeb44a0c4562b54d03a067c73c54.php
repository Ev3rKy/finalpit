...
<div class="alert-err" style="background:#fffbeb;color:#92400e;border-color:#fde68a;margin-bottom:16px">
    No doctors in the staff directory. Add staff with position <strong>Doctor</strong> or <strong>Consultant</strong> in <a href="<?php echo e(route('staff.index')); ?>" class="act-link" style="color:inherit;font-weight:600">Staff &amp; Departments</a>.
</div>
<?php endif; ?>
<div class="stats">
...
<?php echo $__env->make('layouts.module', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pausa\Downloads\V.2\finalpit\finalpit\finalpit\resources\views/appointments/appointment.blade.php ENDPATH**/ ?>