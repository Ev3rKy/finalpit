...
<div class="wrap">
    ...
    <div class="grid">
        ...
        <a href="<?php echo e(route('ward-beds.index')); ?>" class="card <?php echo e($can('ward-beds') ? '' : 'locked'); ?>">
            ...
            <p>Create wards, manage beds, track occupancy, assign patients.</p>
        </a>
...
<?php /**PATH C:\Users\pausa\Downloads\V.2\finalpit\finalpit\finalpit\resources\views/dashboard.blade.php ENDPATH**/ ?>