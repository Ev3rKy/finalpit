...
<div class="sh">
    ...
    <div style="display:flex;gap:8px">
        <a href="<?php echo e(route('ward-beds.index')); ?>" class="btn b-ol">Manage Wards (Module 3)</a>
...
<div class="alert-err" style="background:#fffbeb;color:#92400e;border-color:#fde68a;margin-bottom:16px">
    Add at least one ward in <a href="<?php echo e(route('ward-beds.index')); ?>" style="color:inherit;font-weight:600">Ward &amp; Bed Management</a> before assigning staff to shifts.
</div>
<?php endif; ?>
...
<div class="card" style="margin-bottom:16px">
    <div class="card-hd">
        ...
        <span style="font-size:11px;color:var(--muted)">Wards are created in Ward &amp; Bed Management (Module 3)</span>
    </div>
    <table class="tbl">
        <thead><tr><th>No.</th><th>Name</th><th>Type</th><th>Location</th><th>Capacity</th></tr></thead>
        <tbody>
        ...
        <tr><td colspan="5" style="text-align:center;padding:24px;color:var(--muted)">No wards yet. <a href="<?php echo e(route('ward-beds.index')); ?>">Create wards in Module 3</a>.</td></tr>
        <?php endif; ?>
        </tbody>
    </table>
</div>
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pausa\Downloads\V.2\finalpit\finalpit\finalpit\resources\views/ward-allocation/index.blade.php ENDPATH**/ ?>