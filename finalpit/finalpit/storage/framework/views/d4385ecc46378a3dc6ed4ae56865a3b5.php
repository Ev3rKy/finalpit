...
<div class="form-grid">
    ...
    <label>Doctor<select name="doctor" id="<?php echo e($pfx); ?>doctor" required>
        ...
        <option value="<?php echo e($doc->full_name); ?>"><?php echo e($doc->display_name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <option value="" disabled>Add doctors in Staff &amp; Departments first</option>
        <?php endif; ?>
    </select></label>
...
<?php /**PATH C:\Users\pausa\Downloads\V.2\finalpit\finalpit\finalpit\resources\views/appointments/partials/appointment-form.blade.php ENDPATH**/ ?>