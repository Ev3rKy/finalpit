...
<div class="card">
    ...
    <form method="POST" action="<?php echo e(route('login.post')); ?>">
        ...
        <select id="role" name="role" required>
            ...
            <option value="billing" <?php echo e(old('role') === 'billing' ? 'selected' : ''); ?>>Billing</option>
        </select>
    ...
    <div class="footer">
        New doctor? <a href="<?php echo e(route('register.doctor')); ?>">Register your account</a>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\crest\OneDrive\Desktop\finalpit\finalpit\finalpit\resources\views/auth/login.blade.php ENDPATH**/ ?>