        ...
        <form method="POST" action="<?php echo e(route('admission.store')); ?>">
            ...
            <div class="form-grid">
                ...
                <label>Ward<select name="ward_required">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $wardsForSelect; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <option value="<?php echo e($w->billing_name); ?>">Ward <?php echo e($w->ward_number); ?> — <?php echo e($w->ward_name); ?> (<?php echo e($w->vacant); ?> vacant)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <option value="" disabled>Create wards in Ward &amp; Bed Management first</option>
                    <?php endif; ?>
                </select></label>
...
<?php echo $__env->make('layouts.hospital', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pausa\Downloads\V.2\finalpit\finalpit\finalpit\resources\views/patients/admission.blade.php ENDPATH**/ ?>